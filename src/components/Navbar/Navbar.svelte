...
<div class="relative bg-white">
			...
			<nav class="hidden md:flex space-x-10">
				<Hoverable let:hovering>
					<div class="relative">
						...
						<button
							type="button"
							class="group h-full  group bg-white rounded-md inline-flex items-center text-base font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
							aria-expanded="false"
						>
							<span>Solutions</span>
						...
						{#if hovering}
							<div class="p-3 absolute z-10 w-full">
								<div
									class="absolute z-10 -ml-4 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2 group-hover:block group-focus:block"
								>
									<div
	...
	{#if isMenuOpen}
		<div
			class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden bg-white"
		>
			<div
