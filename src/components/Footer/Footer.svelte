<footer class="px-4 bg-coolGray-100 text-coolGray-800 ">
	<div
		class="container flex flex-col justify-center py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0"
	>
				...
				<div class="flex justify-start space-x-3">
					<a href="#" title="Facebook" class="flex items-center p-1">
						<svg
							...
							fill="currentColor"
							viewBox="0 0 32 32"
							class="w-5 h-5 fill-current text-gray-500 hover:text-gray-900"
						>
							<path
	...
	<div class="py-6 text-sm text-center text-gray-500">© 1968 Company Co. All rights reserved.</div>
</footer>
